...
import './VideoInterviewQuestionPage.css';
import Footer from '../Footer';
import { useLocation } from 'react-router-dom';
import VideoInterviewQuestion from './VideoInterviewQuestion';
  ...
  return (
    <div className='kcreateformpage-con'>
      <div className='kcreateformpage-header'>
        <label className='kcreateformpage-header-title'><b>Create Video Interview for Phase 3</b></label>
        <hr></hr>
        <label className='kcreateformpage-header-job'><b>Job: </b>{job.jobTitle}</label>
      </div>
      <div className='kcreateformpage-middle'>
        <VideoInterviewQuestion job={job}></VideoInterviewQuestion>
      </div>

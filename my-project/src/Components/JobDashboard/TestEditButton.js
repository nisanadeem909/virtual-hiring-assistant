...
export default function TestEditing(props) {
    ...
    return (
      <div className='kp2formcreating-con'>
        <div className='kp2formcreating-header'>
            <label className='kp2formcreating-header-title'>Edit Technical Test for {job.jobTitle}</label>
        </div>
        <div className='kp2formcreating-inner'>
            <button className='kp2formcreating-createbtn' onClick={()=>navigate('\edittest',{state:{'job':job}})}>Edit Technical Test</button>
